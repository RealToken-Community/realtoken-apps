...
List<PieChartSectionData> buildDetailedDonutForOthers(
  ...
  return otherCitiesDetails.map((entry) {
    ...
    final Color lighterColor = _shadeColor(baseColor, 1);
    final Color darkerColor = _shadeColor(baseColor, 0.7);
...
// Ajoutez votre fonction _shadeColor si elle n'est pas déjà globale

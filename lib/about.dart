...
class AboutPage extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            SectionHeader(
                title:
                    S.of(context).application), // Traduction pour "Application"
            ListTile(
            ...
            Padding(
              padding: const EdgeInsets.only(
                  left: 32.0), // Décalage des ListTile pour LinkedIn et GitHub
              child: Column(
                children: [
                  ListTile(
                    ...
                    onTap: () => _launchURL(
                        'https://www.linkedin.com/in/vincent-fresnel/'),
            ...
            ListTile(
              ...
              title: Text(
                S
                    .of(context)
                    .supportProject, // Traduction pour "Soutenez le projet"
                style: TextStyle(
                    fontSize: Platform.isAndroid
                        ? 14
                        : 15), // Ajustement pour Android
              ...
              subtitle: Text(
                S
                    .of(context)
                    .donationMessage, // Traduction pour "Si vous aimez cette application..."
                style: TextStyle(
                    fontSize: Platform.isAndroid
                        ? 13
                        : 14), // Ajustement pour Android
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(
                    ...
                    style: TextStyle(
                        ...
                        color: Colors.white), // Ajustement pour Android
                  ),
  ...
  void _showCryptoAddressDialog(BuildContext context) {
    const cryptoAddress =
        '0x2cb49d04890a98eb89f4f43af96ad01b98b64165'; // Remplacez par votre adresse Ethereum
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(S
              .of(context)
              .cryptoDonationAddress), // Traduction pour "Adresse de Donation Crypto"
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text(S
                  .of(context)
                  .sendDonations), // Traduction pour "Envoyez vos donations à l'adresse suivante"
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      Clipboard.setData(const ClipboardData(
                          text:
                              cryptoAddress)); // Copier l'adresse dans le presse-papiers
                      Navigator.of(context).pop();
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            content: Text(S
                                .of(context)
                                .addressCopied)), // Traduction pour "Adresse copiée dans le presse-papiers"
                      );
                    },
